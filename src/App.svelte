<script lang="ts">
	...
	// We can derive isLoading from whether currentUser is undefined (meaning still loading initial state)
	let isLoading = true

	$: {
		// This block runs reactively whenever $currentUser changes
